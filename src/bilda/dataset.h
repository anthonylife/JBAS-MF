...
public:
    ...
    int * reviewid_set;     // train reviewid list
    //int * reviewidx_set;  // array index of train reviews
    vec reviewidx_set;      // vector index of train reviews 
    ...
    int parse_user_line(char * line, const string dataseg);
    vector<Review*> parse_item_line(char * line, const string dataseg);
};
...
public:
    ...
    colvec pred_rating;  // training prediction
